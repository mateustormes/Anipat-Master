<?php include 'cabecalho.php'; ?>
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Mande uma mensagem para nossa equipe</h2>
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="subject" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder="Informe o motivo do contato">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" Informe sua mensagem"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" placeholder="Informe o seu nome">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Informe o seu E-mail">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>+(18) 99764-8751</h3>
                                <p>Aberto de Segunda até Sexta das 08 - 16 hrs</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>mateus.tormes@hotmail.com</h3>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                <li>+(18) 99764-8751</li>
                                <li><a href="#">mateus.tormes@hotmail.com</a></li>
                            </ul>
                            <ul class="address_line">
                                <li>+(18) 998126-2578</li>
                                <li><a href="#">marcilio@hotmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3  col-md-6 col-lg-3">
                    ...
                    <div class="col-xl-3  col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                ...
                                <li><a href="login.php">Página de Acesso</a></li>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os direitos reservado | Essa plataforma foi feita <i class="ti-heart" aria-hidden="true"></i> por <a href="https://www.linkedin.com/in/mateus-tormes-gervazioni-54090ab1/" target="_blank">Mateus Tormes</a>
