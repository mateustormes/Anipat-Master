...
$categoriaAnimais = json_decode(curl_exec($ch), true);
curl_close($ch);
?>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Categoria Animal</h4>
                <h6 class="card-subtitle">Você pode modificar as categorias dos animais</h6>
                <table id="demo-foo-addrow2" class="table table-bordered table-hover toggle-circle" data-page-size="3">
                        ...
                        <div class="d-flex">
                            <div class="mr-auto">
                                <div class="form-group">
                                    <a href="../categoriaAnimal/index.php?status=cadastrar">
                    ...
                    <tbody>
                        <?php foreach($categoriaAnimais as $categoriaAnimal){ ?>
                        <tr>
                            <td><?php echo $categoriaAnimal['id']; ?></td>
                            <td><?php echo $categoriaAnimal['descricao']; ?></td>
                            <td><span class="label label-table label-success"><?php echo $categoriaAnimal['fk_status']['descricao'] == 'Ativo' ? 'Ativo': 'Inativo'; ?></span> </td>
                            <td>                                    
                                <a href="<?php echo '../categoriaAnimal/index.php?status=editar&id='.$categoriaAnimal['id']; ?>">
                                ...
                                <a href="<?php echo '../categoriaAnimal/modificar.php?status=remover&id='.$categoriaAnimal['id']; ?>">
