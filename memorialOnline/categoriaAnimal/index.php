    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <?php if($_GET['status'] == 'cadastrar'){ ?>
                <h4 class="modal-title" id="cadastrar">Adicionar Categoria Animal</h4>
            <?php }else{ ?>
                <h4 class="modal-title" id="editar">Editar Categoria Animal</h4>
            <?php } ?>
        </div>
        <div class="modal-body">
            <form action="" method="POST" class="form-horizontal form-material">
                ...
                <a href="../categoriaAnimal/modificar.php">
...
if(isset($_POST['nome'])){
    ...
    if($status == 'cadastrar'){
        ...
        $make_call = pullAPI('POST', $configConexao.'categoriaAnimal', json_encode($data_array));
        ...
        $make_call = pullAPI('PUT', $configConexao.'categoriaAnimal/'.$_GET['id'], json_encode($data_array));
        $response = json_decode($make_call, true);
    }
}
